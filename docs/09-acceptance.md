...
- M 的當月站群、班位最少／最多人數、零需求班位禁排、三種外援等級與跨月夜–休–早／午符合文件；「允許」站共用 70 人次免罰額度，「盡量不要」站從第一人次計分。首月相容設定中 LB02／LB04／LB11 為「允許」、LB09 為「盡量不要」。MS03 沿用 CS04 工作區段邊界，區段內出現超過一種正常班型時計 +1。
