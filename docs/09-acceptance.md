...
- M 的假日休假公平只比較同站群整月人員，每群以 `floor(10 × Σ|群組人數 × 個人次數 − 群組總次數| ÷ 群組人數)` 計分；平日休假公平不建模。早小班每人差距超過 4 才計罰；夜班以每人 3–4 天為零罰分目標，並檢查 0–8 天的罰分依序為 10、5、1、0、0、4、8、12、16。三項權重為假日休假 5、早小差距 2、夜班目標 50。
