...
public sealed class MSolverTests
{
    ...
    public void CliPortfolioPrefersCompleteThenLexicographicallyBetterMResult()
    {
        ...
        MSolveResult Result(params ObjectiveScore[] scores) => new(
            ...
            []);
        var compare = typeof(NtmcScheduler.Cli.Program).GetMethod(
            "CompareMResults",
    ...
    {
        var parse = typeof(NtmcScheduler.Cli.Program).GetMethod(
            "ReadMSearchOptions",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static)!;
        ...
        Assert.AreEqual(8, defaults.GetType().GetProperty("Workers")!.GetValue(defaults));
