...
\paragraph{Exact monthly leave-rest count (\texttt{CH06})}
...
\paragraph{Shift-count fairness (\texttt{MS09})}
...
\paragraph{Monthly-shift adherence (\texttt{TS06})}
...
\[
  C_{ds}=\sum_{e\in\mathcal{E}^{T}}\alpha_e x^{T}_{eds}.
\]
定義能力不足量
\[
  \delta^{ability}_{ds}
