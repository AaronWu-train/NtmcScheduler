...
第一個穩定版為 **v1.0.0**（2026-08-18，git tag `v1.0.0`）；目前穩定版為 **v1.0.1**（git tag `v1.0.1`）。產品範圍仍是「第一版」（站務 M、檢修 T）。正式 Linux＋SQL Server 部署驗收與上線前密碼政策見 `docs/11-implementation-plan.md`。
